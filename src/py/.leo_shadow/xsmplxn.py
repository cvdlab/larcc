#@+leo-ver=4-thin
#@+node:paoluzzi.20131122061759.1686:@shadow ../Documents/dev/test/larcc/src/py/smplxn.py
#@@language python
#@@tabwidth -4
#@+others
#@+node:paoluzzi.20131122061759.1687:smplxn declarations

from larcc import *

#@-node:paoluzzi.20131122061759.1687:smplxn declarations
#@+node:paoluzzi.20131122061759.1688:VERTEXTRUDE
#------------------------------------------------------------------
...
#@-node:paoluzzi.20131122061759.1688:VERTEXTRUDE
#@+node:paoluzzi.20131122061759.1689:cumsum
def cumsum(iterable):
...
#@-node:paoluzzi.20131122061759.1689:cumsum
#@+node:paoluzzi.20131122061759.1690:larExtrude
...
#@-node:paoluzzi.20131122061759.1690:larExtrude
#@+node:paoluzzi.20131122061759.1691:simplexGrid
...
#@-node:paoluzzi.20131122061759.1691:simplexGrid
#@+node:paoluzzi.20131122061759.1692:simplexFacets
if __name__ == "__main__":
